...
from .mpr import sap_create_solve_mpr, sap_create_support_map_function
from .multicontact import sap_create_build_manifold
from .simplex import sap_create_solve_closest_distance


def sap_create_solve_convex_multi_contact(support_func: Any, writer_func: Any, post_process_contact: Any):
    ...
    support_funcs = sap_create_support_map_function(support_func)
    solve_mpr = sap_create_solve_mpr(support_func, _support_funcs=support_funcs)
    solve_gjk = sap_create_solve_closest_distance(support_func, _support_funcs=support_funcs)

    @wp.func
    def sap_solve_convex_multi_contact(
        geom_a: Any,
        geom_b: Any,
        ...
        count = wp.static(
            sap_create_build_manifold(support_func, writer_func, post_process_contact, _support_funcs=support_funcs)
        )(
            geom_a,
            geom_b,
            orientation_a,
    ...
    return sap_solve_convex_multi_contact


def sap_create_solve_convex_single_contact(support_func: Any, writer_func: Any, post_process_contact: Any):
    ...
    @wp.func
    def sap_solve_convex_single_contact(
        geom_a: Any,
        geom_b: Any,
        orientation_a: wp.quat,
        orientation_b: wp.quat,
    ...
    return sap_solve_convex_single_contact
